...
define('WIDGET_PROBLEMS_TAGS_SHOW_TOTALS', 0); // New Widget
define('WIDGET_PROBLEMS_TAGS_SHOW_TOTALS', 1); // New Widget
...
define('WIDGET_PROBLEMS_TAGS',		'problemstags'); // New Widget
